...
public class HotelHashMap {
	public static void main(String[] args) {
		 ...
		 * annapurnaMenu.put("Idly", 20); annapurnaMenu.put("Dosa", 25);
		 * annapurnaMenu.put("Masala Dosa", 30); annapurnaMenu.put("Puri", 30);
		 */
		...
		/*
		 * Map<String, Integer> udipiMenu = new HashMap<>(); udipiMenu.put("Idly", 30);
		 * udipiMenu.put("Dosa", 35); udipiMenu.put("Masala Dosa", 40);
		 * udipiMenu.put("Puri", 30); udipiMenu.put("rava dosa", 50);
		 */
