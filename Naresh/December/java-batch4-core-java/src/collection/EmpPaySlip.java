...
public class EmpPaySlip {
	...
	public EmpPaySlip(int empId, String empName, String month, int totalAnnualSalary, int basicSalary, int allowance,
			int monthlySalary, int taxDeducted, int salaryCredited, int ptax, int extra) {
		super();
		this.empId = empId;
	...
	public String toString() {
		return "EmpPaySlip [empId=" + empId + ", empName=" + empName + ", month=" + month + ", totalAnnualSalary="
